...
EnoDischarge <- readNWISdv(siteNumbers = "02096500",
                     ...
                     startDate = "2009-09-01", # leave as "" to get all data
                     endDate = "2019-08-31")
...
> It is difficult to compare the baseflow of the five rivers using the plots created, but the Eno River has the largest discharge events. The Bitterroot may have the largest average flow.
...
> The Bitterroot is especially seasonal, as is the Nehalem.
...
```{r}  
BitterrootDischarge.Historical <- readNWISdv(siteNumbers = "02096500",
                     parameterCd = "00060", # discharge (ft3/s)
