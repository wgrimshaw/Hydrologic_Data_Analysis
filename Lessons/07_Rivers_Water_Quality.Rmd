...
> Physical, chemical, and biological characteristics of water. It is complementary to water quantity and can be used to determine for what uses the water is fit.
...
> Indicate what organisms or species may be able to live in the water.

What types of disturbances can impact these parameters?

> pH: acid rain, acid mine drainage, other pollution.

> specific conductance: ionic strength can also indicate what organisms can live in the water and whether is needs to be treated before human consumption. salt water intrusion could impact ionic strength, as could anthropogenic pollution.
...
> The Kanawha River has been monitored much longer than Twelvepole Creek. The pH of Kanawha appears to increase after approximately 1967. There are two few data points taken from Twelvepole creek to have high confidence about a trend in the pH. The specific conductivity of the Kanawha was stable before 1960 and after about 1972, but it has high and erratic peaks between those years. After 1970, the conductance of both rivers was more stable, whith the conductance of the Kanawha consistently higher than that of Twelvepole.

Why might mining be causing the changes you see?

> May have caused the dip in pH of the Kanawha and more pollutants would increase conductivity.
...
> Roughly monthly. It may have been expensive and/or cumbersome to collect such data in the 60s and 70s.
...
> While the parameters leveled off for the Kanawha river after 1977, pH in Twelvepole Creek declined substantially after 1977.
...
> The average annual specific conductance before the SMCRA was significantly higher than the average annual specific conductance after the SMCRA in Kanawha River.

What can you say with data visualization that you can't say with just the statistical tests?

> Easier to see the difference in magnitude.
...
Manganese.points <- ggplot(Manganese.dat, aes(x = Date, y = Manganese_ugL)) +
  geom_point() +
  geom_vline(xintercept = 1977, color = "grey", alpha = 0.8, lwd = 2, lty = 2) + 
  labs(y = expression("Manganese ("*mu*g*l^-1*")")) +
  ggtitle("Manganese Concentrations in the Kanawha River")

print(Manganese.points)
```
...
> The Kanawha iss above the drinking water standards consistently.
