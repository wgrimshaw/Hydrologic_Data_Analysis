...
Populations for water utilities over time and expenditures on capital improvement projects. Both would be continuous numerical data.

Potentially also cities on an axis of percent population change vs bond issuance.
...
```{r}  
## add new column with metric discharge
EnoDischarge$Dischargem3 <- EnoDischarge$Discharge*0.0283

## add rolling 30-day mean column
EnoDischarge$30daymean <- rollmean(x = EnoDischarge$Dischargem3, k = 30,
                                       fill = NA)
